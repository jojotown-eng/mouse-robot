...
(library Library_1
	...
	(patternDef "OS5RKA5111P" (originalName "OS5RKA5111P")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.300, 0.000) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.27 0) (pt -1.27 0) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.54) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.81 0) (pt 3.81 0) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.54) (startAngle .0) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "OS5RKA5111P" (originalName "OS5RKA5111P") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "Datasheet Link" "http://akizukidenshi.com/download/ds/optosupply/OS5RKA5111P.pdf")
	)
