...
(library Library_1
	...
	(patternDef "ST1KL3A" (originalName "ST1KL3A")
		...
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.7) (startAngle 180) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "ST-1KL3A" (originalName "ST-1KL3A") (compHeader (numPins 2) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://www.kodenshi.co.jp/files/product/ST-1KL3A.pdf")
		(attr "<Component Height>" "6.7")
		(attr "<STEP Filename>" "ST-1KL3A.stp")
